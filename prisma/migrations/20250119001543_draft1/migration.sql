...
*/
-- CreateEnum
CREATE TYPE "ItemOptions" AS ENUM ('ALCOHOLIC', 'GLUTEN_FREE', 'VEGETARIAN');

-- CreateEnum
CREATE TYPE "ItemAllergens" AS ENUM ('DAIRY', 'EGGS', 'FISH', 'GLUTEN', 'PEANUTS', 'SOY', 'TREE_NUTS');
...
CREATE TABLE "Item" (
    ...
    "options" "ItemOptions" NOT NULL,
    "allergens" "ItemAllergens" NOT NULL,
...
-- AddForeignKey
ALTER TABLE "ModifierGroup" ADD CONSTRAINT "ModifierGroup_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
